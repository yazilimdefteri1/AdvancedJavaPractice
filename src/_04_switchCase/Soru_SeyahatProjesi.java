        ...
        switch (hedef) {
                ...
                switch (kisi) {
                    case 1:
                        System.out.println("1 kişilik bilet talep ettiniz " + "bilet tutarınız : "
                                + frUcret + " EURO" + "güncel bakıyeniz: " + (bakıye -= frUcret));


                        break;
                    case 2:
                        System.out.println("2 kişilik bilet talep ettiniz " +
                                "bilet tutarınız : " + (frUcret * 2) + " EURO" + "güncel bakıyeniz: " + (bakıye -= frUcret * 2));
            ...
            case "KOLN":
                ...
                switch (kisi1) {
                    case 1:
                        System.out.println("1 kişilik bilet talep ettiniz " + "bilet tutarınız : "
                                + klUcret + " EURO" + "güncel bakıyeniz: " + (bakıye -= klUcret));

                        break;
                    case 2:
                        System.out.println("2 kişilik bilet talep ettiniz " +
                                "bilet tutarınız : " + (klUcret * 2) + " EURO" + "güncel bakıyeniz: " + (bakıye -= klUcret * 2));

...
public class ManavProject {
    ...
    private static void musteriSecim() {
        System.out.print("sectiginiz ürün kodu giriniz : ");
        int secim = scan.nextInt();
        System.out.print("sectiginiz üründen kaç kilo alacaksiniz : ");
        double kilo = scan.nextDouble();
        double urunTutari = kilo * urunFiyatlari.get(secim - 1);
        toplamOdeme += urunTutari;
        System.out.println("Alisverise devam etmek istiyorsaniz - 1   kasaicin  -2 seciniz : ");
    ...
    private static void kasa() {
        System.out.println("Yine Bekleriz. Toplam Fatura Tutari = " + toplamOdeme);
    }
}

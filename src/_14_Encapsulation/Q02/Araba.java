...
public class Araba {// POJO : planing old java object->modal class
    ...
    public Araba(String model, String renk, int motor, int yil) {// p'li cons.
        ...
        //this.motor = motor;
       // this.yil = yil;
        setMotor(motor); // constructor obj uretmek icin parametre olarak giren datasi
                        // motor datasi setMotor methoduna parametre olarak calisti degerini aldi
        setYil(yil);
    }
    ...
    public void setYil(int yil) {
        if(yil<0){
            this.yil = (-1)*yil;
            System.out.println("Agam M.O araba m, vardi");
        }else
        this.yil = yil;
    }
